...
export function buildHumanoidUpperBody(
  ...
  // The mesh is generated by physical X side, while region/bone indices stay anatomical.
  for (const [regionIndex, side, shoulder] of [[2, -1, rig.rightArm], [1, 1, rig.leftArm]] as const) {
